var door = {      
    guanqia:[
        {"name_guanqia":"round 1 开始","player_location":[-320,0],"sun_location":[368,0],"playTime":10,"num_yinli":1,"array_bolck":[]},//第一关
        {
        ...
        },//第四关
        {
            ...
            "array_bolck":[
                ...
                {"x":-167,"y":65,"where":90},
                {"x":-33,"y":65,"where":90},
                {"x":117.8,"y":70.7,"where":90},
                {"x":273,"y":70.7,"where":90},
                {"x":273,"y":-89,"where":90},
                {"x":273,"y":-174,"where":90},
                {"x":118,"y":-89,"where":90},
                {"x":118,"y":-174,"where":90},
                {"x":-134,"y":-189,"where":120},
                {"x":-72,"y":-81,"where":120},
                {"x":-205.1,"y":-81,"where":120},
                {"x":-261,"y":-179,"where":120}
            ]
        },//第五关
         {
        ...
        },//第6关
         {
            ...
            "array_bolck":[
                {"x":-232,"y":54,"where":-34},
                {"x":-156,"y":105,"where":-34},
                {"x":-66,"y":166,"where":-34},
                {"x":-228,"y":-107,"where":34},
                {"x":-153,"y":-157,"where":34},
                {"x":-88.3,"y":74,"where":90},
                {"x":-88.3,"y":-125,"where":90},
                {"x":-20.8,"y":105,"where":34},
                {"x":54.1,"y":54.5,"where":34},
                {"x":180,"y":56,"where":-34},
                {"x":-73,"y":-211,"where":34},
                {"x":-20,"y":-156.3,"where":-34},
                {"x":53,"y":-107,"where":-34},
                {"x":180,"y":-106,"where":34},
            ]
        },//第7关
        {
        ...
        },//第8关
        {
            ...
            "array_bolck":[
                ...
                {"x":0,"y":-168,"where":90},
                {"x":0,"y":0,"where":0},
                {"x":-160.7000161,"y":0,"where":0},
                {"x":-321.4000482,"y":0,"where":0},
                {"x":-482.1000964,"y":0,"where":0},
        ...
        },//第9关
        {
            ...
            "num_yinli":1,
            "array_bolck":[
                {"x":-211,"y":179,"where":45},
                {"x":-47,"y":15,"where":45},
                {"x":99,"y":-131,"where":45},
                {"x":160,"y":-192,"where":45},              
            ]
        },//第10关
        {
        ...
        },//第13关
        {
            ...
            "array_bolck":[
                {"x":0,"y":0,"where":0},
                {"x":-125,"y":125,"where":90},
                {"x":-125,"y":0,"where":90},
                {"x":-125,"y":-100,"where":90},  
                {"x":125,"y":125,"where":90},
                {"x":125,"y":0,"where":90},
                {"x":125,"y":-100,"where":90},             
            ]
        },//第14关
        {
            ...
            "array_bolck":[
                ...
                {"x":-287,"y":165,"where":90},
                {"x":-136,"y":165,"where":90},
                {"x":132,"y":165,"where":90},
                {"x":286,"y":165,"where":90},

                {"x":-287,"y":8,"where":90},
                {"x":286,"y":8,"where":90},

                {"x":-287,"y":-146,"where":90},
                {"x":-136,"y":-146,"where":90},
                {"x":132,"y":-146,"where":90},
                {"x":286,"y":-146,"where":90}, 
            ]
        },//第15关
        {
            ...
            "array_bolck":[
                ...
                {"x":-319,"y":158,"where":90},
                {"x":-319,"y":1,"where":90},
                {"x":-319,"y":-149,"where":90},
                {"x":300,"y":158,"where":90},
                {"x":300,"y":7,"where":90},
                {"x":300,"y":-148,"where":90},
